...
const METRICS = [
  ...
  { label: "Active connections", value: "1,240", subtext: "Peak concurrent", color: "text-slate-800" },
    ...
    <div className="space-y-6 animate-in fade-in duration-500 pb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-3">
        {METRICS.map((metric, i) => (
          <Card 
            key={i} 
            className="bg-white border-none shadow-sm rounded-xl transition-all cursor-pointer hover:ring-1 hover:ring-primary/20"
          >
            ...
            <TableBody>
              {missingIndexes.map((idx, i) => (
                <TableRow key={i} className="hover:bg-slate-50/50 border-b border-slate-50 last:border-0">
                  ...
                  <TableCell>
                    <span className="text-[10px] font-bold text-slate-400 italic">Used in: ( {idx.sp} )</span>
                  </TableCell>
